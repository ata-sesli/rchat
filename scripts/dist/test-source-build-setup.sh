...
for package in libwebkit2gtk-4.1-dev libayatana-appindicator3-dev libasound2-dev libopus-dev libvpx-dev libpipewire-0.3-dev libwayland-dev libavahi-compat-libdnssd-dev clang libclang-dev pkg-config; do
...
for package in libpipewire-0.3-dev libwayland-dev libvpx-dev; do
...
grep -q 'require_module wayland-client' "$SCRIPT_DIR/doctor.sh"
