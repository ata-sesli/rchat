...
DEB_DEPS="libwebkit2gtk-4.1-0 libgtk-3-0 libayatana-appindicator3-1 librsvg2-2 libasound2 libssl3 libavahi-client3 libavahi-compat-libdnssd1"
RPM_DEPS="webkit2gtk4.1 gtk3 libayatana-appindicator-gtk3 librsvg2 alsa-lib openssl-libs avahi-compat-libdns_sd"
