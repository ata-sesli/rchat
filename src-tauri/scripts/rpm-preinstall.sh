...
REQUIRED_PACKAGES="webkit2gtk4.1 gtk3 libayatana-appindicator-gtk3 librsvg2 alsa-lib openssl-libs opus libvpx avahi-compat-libdns_sd pipewire xdg-desktop-portal xdg-desktop-portal-gnome"
