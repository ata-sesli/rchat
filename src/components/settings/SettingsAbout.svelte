...
<div class="space-y-6 animate-fade-in-up">
  ...
  <div class="flex flex-col items-center text-center py-6">
    <div
      class="w-20 h-20 rounded-2xl shadow-xl mb-4 bg-teal-500/20 text-teal-400 flex items-center justify-center"
    >
  ...
  <div class="space-y-3">
    ...
    <div class="p-4 bg-slate-900 border border-slate-800 rounded-xl">
      ...
      <p class="text-sm text-slate-400">Open source software. MIT License.</p>
    </div>
  </div>
</div>
